                        ...
                        <div class="input-group-btn">
                            ...
                            <ul id="selectSubject" class="dropdown-menu">
                                <c:forEach items="${subjectList}" var="subject">
                                    <li value="${subject.id}"><a href="#" onclick="showName3(this,${subject.id})">${subject.subjectName}</a></li>
                                </c:forEach>
...
<script>
    ...
    function commitForm() {
        ...
        $.post("${pageContext.request.contextPath}/course/saveOrUpdate", $("#formLoad").serialize(), function(date){
         if (date == 'success') {
