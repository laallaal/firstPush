        ...
        <div class="container">
            <span>欢迎来到Y先生教育！</span>
	            ...
	            <div id="regBlock" style="display:none;float:right">
	               <a href="javascript:" id="reg_open"><img alt="" src="${pageContext.request.contextPath}/img/we.png">注册</a>
	               <a href="javascript:" id="login_open"><img alt=""  src="${pageContext.request.contextPath}/img/we.png">登录</a>
	            </div>
            ...
            <a onclick="addFavorite2()"><img alt=""  src="${pageContext.request.contextPath}/img/sc.png" draggable="false">加入收藏</a>
            <a onclick="pyRegisterCvt()" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2580094677&site=qq&menu=yes"><img alt=""  src="${pageContext.request.contextPath}/img/we.png" draggable="false">联系我们</a>
            <a class="color_e4"><img alt="111" src="${pageContext.request.contextPath}/img/phone.png" draggable="false"> 0375-2089092&#x3000;&#x3000;0375-208-9051</a>

        </div>
    </header>
    <nav class="w100">
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='index.html'" draggable="false">
                    ...
                    <ul>
                        ...
                        <c:forEach items="${course.videoList}" var="video" varStatus="i" >
                                 <li class="section-main"  onclick="getVideo(${video.id})">
		                            <div class="thum" style="background-image: url('${video.videoImgUrl}')">
        ...
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="loginForm" action="#">
                    ...
                    <input type="submit" onclick="return commitLogin2()" value="登&#x3000;录">
                </form>
            </div>
        ...
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="regForm" action="user/insertUser">
                    <h3>新用户注册</h3>
                    <label for="regEmail"></label><input type="email" id="regEmail" placeholder="请输入邮箱" name="email"><span id="emailMsg"></span>
                    <label for="regPsw"></label><input type="password" id="regPsw" placeholder="请输入密码" name="password">
                    <label for="regPswAgain"></label><input type="password" id="regPswAgain" placeholder="请再次输入密码" name="psw_again"><span id="passMsg"></span>
                    <div id="yzm" class="form-inline">
                        <label>
                            <input type="text" name="wzp" style="width: 45%; display: inline-block;">
                        </label>
