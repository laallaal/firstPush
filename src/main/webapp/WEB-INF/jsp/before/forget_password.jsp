              ...
              $("#yzmBtn").click(function(){
                 ...
                 if(null!=email.val() && email.val()!=""){
                      //alert("====");
	                    ...
	                    $.post("${pageContext.request.contextPath}/user/sendEmail", params, function(data){
	                      if(data=="success"){
	                         alert("邮件发送成功");
	                      }else{
	                         alert("邮件发送失败");
...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" href="${pageContext.request.contextPath}/user/reset_password"  method="post">
                ...
                <div class="form_body">
                    ...
                    <input  id="yanzhengma" type="text" placeholder="请输入验证码" name="code"><input type="button" id="yzmBtn" value="获取验证码"/>
                    <input type="submit" value="提交" onclick=" forgetSuccess()">
                </div>
...
<script>
    ...
    function forgetSuccess() {
        ...
        $.post("${pageContext.request.contextPath}/user/validateEmailCode", params, function (date) {

            if (date == 'success') {

                location.href = "${pageContext.request.contextPath}/user/ToResetPassword"
