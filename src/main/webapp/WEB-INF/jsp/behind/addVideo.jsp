    ...
    <script type="text/javascript">
        ...
        function validateInput2(obj) {
            ...
            if (!/^http:\/\/[a-z]+\.[a-z0-9]+\.[a-z]{2,}$/.test(value)) {
                alert("必须输入正确邮箱！！ 例如：http://www.baidu.com");
            }
        }
    ...
    <form class="form-horizontal" id="formLoad" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <c:if test="${empty video.time}">
                    <input type="number" class="form-control" value="0" name="time" placeholder="精确到毫秒（正整数）" onblur="validateInput(this)">
                </c:if>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="url" name="videoUrl" class="form-control" value="${video.videoUrl}" placeholder="具体的url" onblur="validateInput2(this)">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div id="photo">
                    <c:if test="${empty video.videoImgUrl}">
                        <img  width='100px' height='100px' src='${pageContext.request.contextPath}/images/erha.jpg'/>
                    </c:if>
                    <c:if test="${not empty video.videoImgUrl}">
                        <img  width='100px' height='100px' src='${video.videoImgUrl}'/>
                    </c:if>

                </div>
                <input type="hidden" id="videoImgUrl" name="videoImgUrl" class="form-control" value="${video.videoImgUrl}" >
            </div>
...
<script>
    ...
    function commitForm() {
        ...
        $.post("${pageContext.request.contextPath}/video/saveOrUpdate", $("#formLoad").serialize(), function(date){
         if (date == 'success') {
